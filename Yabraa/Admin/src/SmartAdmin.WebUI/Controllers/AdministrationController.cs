...
using SmartAdmin.WebUI.ViewModel.AccountViewModels;
  ...
  int? pageNumber)
        {
            ...
            var users = (from s in userManager.Users
                         where s.Id != "039e233e-da34-4bbc-aa4a-8b5ff8942e48" && s.IsSystemUser
        ...
        public async Task<IActionResult> EditUser(string id)
        {
            ...
            ViewData["countries"] = new SelectList(Countries, "CountryCode", "CountryArNationality", "SA");
        ...
        public async Task<IActionResult> ManagePermissions(string roleId)
        {
          ...
          var roleClaims = roleManager.GetClaimsAsync(role).Result.Select(c => c.Value).ToList();
            // var roleClaims = roleManager.GetClaimsAsync(role).Result.Where(c => !c.Value.Contains("Roles") && !c.Value.Contains("Users")).Select(c => c.Value).ToList();

            // var allClaims = Permissions.GenerateAllPermissions().Where(c => !c.Contains("Roles") && !c.Contains("Users"));
        ...
        public async Task<IActionResult> ManagePermissions(PermissionsFormViewModel model)
        {
            ...
            // var roleClaims = roleManager.GetClaimsAsync(role).Result.Where(c => !c.Value.Contains("Roles") && !c.Value.Contains("Users"));
