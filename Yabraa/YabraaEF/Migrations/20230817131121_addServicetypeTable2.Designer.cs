...
namespace YabraaEF.Migrations
{
    ...
    [Migration("20230817131121_addServicetypeTable2")]
    partial class addServicetypeTable2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("YabraaEF.Models.ServiceType", b =>
                {
                    b.Property<int>("ServiceTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("YabraaEF.Models.VisitAttachments", b =>
                {
                    b.Property<long>("VisitAttachmentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<long>("VisitAttachmentId"), 1L, 1);
                    ...
                    b.Property<long>("VisitDetailsId")
                        .HasColumnType("bigint");

                    b.HasKey("VisitAttachmentId");
            ...
            modelBuilder.Entity("YabraaEF.Models.VisitDetails", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<long>("VisitDetailsId"), 1L, 1);
            ...
            modelBuilder.Entity("YabraaEF.Models.VisitNotes", b =>
                {
                    b.Property<long>("VisitNoteId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<long>("VisitNoteId"), 1L, 1);
            ...
            modelBuilder.Entity("YabraaEF.Models.Service", b =>
                {
                    b.HasOne("YabraaEF.Models.ServiceType", "ServiceType")
                        .WithMany("Services")
            ...
            modelBuilder.Entity("YabraaEF.Models.VisitAttachments", b =>
                {
                    b.HasOne("YabraaEF.Models.VisitDetails", "VisitDetails")
                        .WithMany("VisitAttachments")
            ...
            modelBuilder.Entity("YabraaEF.Models.VisitDetails", b =>
                {
                    ...
                    b.HasOne("YabraaEF.Models.UserFamily", "UserFamily")
                        .WithMany("VisitDetails")
                        .HasForeignKey("UserFamilyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
